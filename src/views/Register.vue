    ...
    <div class="auth-right">
      <div class="auth-card">
        ...
        <form @submit.prevent="handleRegister" class="auth-form">
          ...
          <div class="form-group">
            <label>密码</label>
            <input v-model="password" type="password" class="or-input" placeholder="至少 8 位" />
          </div>

          <div class="form-group">
            <label>确认密码</label>
            <input v-model="confirmPwd" type="password" class="or-input" placeholder="再次输入密码" />
          </div>
        ...
        <p class="auth-switch">
          已有账号? <router-link to="/login"><strong>立即登录</strong></router-link>
        </p>
      </div>
    </div>
  </div>
